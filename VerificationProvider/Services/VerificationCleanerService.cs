...
public class VerificationCleanerService(ILogger<VerificationCleanerService> logger, VerificationDataContext context)
{
    private readonly ILogger<VerificationCleanerService> _logger = logger;
    private readonly VerificationDataContext _context = context;
